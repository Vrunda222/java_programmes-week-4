package homework_week_4.programme_26_encapsulation;

public class Encapsulate {
    //private variables decalred these can only be accessed by public methods of class
    private String name;
    private int rollNo;
    private int age;
    ...
    //get method name to access private variable name
